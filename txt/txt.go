...
var locales = map[string]map[string]string{
	...
	"text.memberRemovedNotification": {
		"ru": "Привет. %s только что удалил тебя как %s из собрания %s ☹️",
		"uk": "Привіт. %s щойно видалив тебе як %s із заходу %s ☹️",
	},
	"text.memberAddedNotification": {
		"ru": "Привет. %s только что добавил тебя как %s в собрание %s!",
		"uk": "Привіт. %s щойно додав тебе як %s у захід %s!",
	},
	"button.moreInfo": {
		"ru": "ℹ️ Подробнее",
		"uk": "ℹ️ Докладніше",
	...
	"text.upcomingEventNotification": {
		"ru": "Привет. Ты участвуешь в собрании через несколько дней (%s)!",
		"uk": "Привіт. Ти береш участь у заході через кілька днів (%s)!",
	},
	"button.schedule": {
		"ru": "🗓️ Расписание",
		"uk": "🗓️ Розклад",
