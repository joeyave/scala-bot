...
var locales = map[string]map[string]string{
	...
	"text.changeLocation": {
		"ru": "Для правильной работы расписания, уведомлений и т. д. боту нужно понимать, в каком часовом поясе вы находитесь. По умолчанию бот использует киевское время. Для того, чтобы установить другой часовой пояс, нажми на кнопку ниже или отправьте свою геопозицию.",
		"uk": "Для правильної роботи розкладу, повідомлень і т.д. боту потрібно розуміти, в якому часовому поясі ви знаходитесь. За замовчуванням бот використовує київський час. Щоб встановити інший часовий пояс, натисніть на кнопку нижче або відправте свою геопозицію.",
	},
	...
	"text.yourTimeZone": {
		"ru": "Твой часовой пояс - <b>%s</b>. Если это не так, попробуй выслать мне локацию столицы твоей страны.",
		"uk": "Твій часовий пояс - це <b>%s</b>. Якщо це не так, спробуй відправити мені локацію столиці твоєї країни.",
	},
